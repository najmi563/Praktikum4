    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                $ns1 = new Mahasiswa("012011", "Muhamad Agil Akbar Maulana", 2021, "TI", 3.89, "Cum Laude");
                $ns2 = new Mahasiswa("012012", "Ahmad Fauzi Ariyanto",  2021, "TI", 3.9, "Cum Laude");
                $ns3 = new Mahasiswa("011011", "Rafly al-hakim", 2021, "TI", 3.46, "Memuaskan");
                $ns4 = new Mahasiswa("011012", "Muafa arik atulloh", 2021, "TI", 3.2, "Memuaskan");
